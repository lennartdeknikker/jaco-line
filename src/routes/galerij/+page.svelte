	...
	{#if data.images.length > 0}
		<div class="gallery-grid">
			{#each data.images as image}
				...
				>
					<img
						src={image.image?.url || '/images/foto1.jpg'}
...
{#if selectedImage}
	<div
		...
		on:keydown={(e) => (e.key === 'Escape' || e.key === 'Enter') && closeLightbox()}
		role="button"
		tabindex="0"
		aria-label="Sluiten"
	>
		<button class="lightbox-close" on:click={closeLightbox} aria-label="Sluiten">×</button>
		<img
			src={selectedImage.image?.url || '/images/foto1.jpg'}
